...
public class EmailService {
	public static void main(String[] args) {
		new EmailService().sendEmail("c535346094@gmail.com","http://localhost:8080/JavaWebCart/");
	}
	// Google應用程式密碼
	// 請參考此篇 https://www.yongxin-design.com/Article/10
	// 請自行產生Google應用程式密碼
	String googleAppPassword = "zttf tpby pydh qpsz";

	// 寄件者的電子郵件地址
	String from = "c535346094@gmail.com";
